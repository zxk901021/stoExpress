...
import com.zhy_9.stoexpress.view.TitleIndicator;
...
public abstract class IndicatorFragmentActivity extends FragmentActivity
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPager.setPageMarginDrawable(R.color.white);
	}
	...
	private final void initViews() {
		...
		title = (TitleView) findViewById(R.id.indicator_title);
	}
	...
	public void setRightText (String rightTextStr) {
		title.setRightText(rightTextStr);
	}
	
	public void setRightTextDrawable(int resId){
		title.setRightTextDrawable(resId);
	}
	
	public void setRightTextGone(boolean isGone){
		title.setRightTextGone(isGone);
	}
	
	public void setRightTextListener(RightBtnCallBack callBack){
		title.rightTextListener(callBack);
	}
